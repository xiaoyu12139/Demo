...
BOOL CMFCApplication1App::InitInstance()
{
...

	{
		...
		m_cefApp = new CEFRenderApp();
		const int exit_code = CefExecuteProcess(main_args, m_cefApp, nullptr);
		if (exit_code >= 0) {
			return FALSE;
		}
		...
		m_cefInitialized = CefInitialize(main_args, settings, m_cefApp, nullptr) ? true : false;
	}
